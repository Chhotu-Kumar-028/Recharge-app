...
const familySharingSchema = new mongoose_1.Schema({
    senderId: {
...
const FamilySharing = mongoose_1.default.model('FamilySharing', familySharingSchema);
exports.default = FamilySharing;
